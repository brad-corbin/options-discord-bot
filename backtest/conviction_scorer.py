...
DEFAULT_POST_THRESHOLD = 75    # ≥ this → Telegram post
...
def _boost_b4_diamond_pinescript(ctx: Dict) -> int:
    """B4: diamond=True (pinescript only). Batch 2."""
    if (_safe_bool(ctx, "diamond", False)
            and _safe_str(ctx, "scoring_source") == "pinescript"):
        return 2
    return 0
...
_BOOST_REGISTRY = [
    ...
    ("B4",  _boost_b4_diamond_pinescript),
