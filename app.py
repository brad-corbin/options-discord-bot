...
WATCHLIST = os.getenv("WATCHLIST", "SPY,QQQ,NVDA,AAPL,MSFT,META,GOOGL,CAT,BE,XOM,GLD,SLV,NEM,FDX,PLTR,IREN,LMND,SOFI,ALAB,NBIS,GTLB,DBX,FRSH,KLAR,PFE,NOC,LMT,HAL,RTX,XLE,HII,IWM,HD,LOW,IAU,ITA,TSLA,TE,ONDS,BBAI,MRNA,OXY,CIFR,INOD,DUOL,CORT,ALZN,RXRX,RBLX,EOSE,HOOD").split(",")
