...
def check_ticker_with_timeout(ticker, direction="bull", webhook_data=None, timeout_sec=45):
    result = {}
    exc_holder = []
...
LIQUID_SYMBOLS = {
    "SPY", "QQQ", "SPX", "NDX", "AAPL", "NVDA", "TSLA", "AMZN", "META", "MSFT",
    "GOOGL", "GOOG", "AMD", "NFLX", "COIN", "MSTR", "ARM", "PLTR", "SMCI",
}
