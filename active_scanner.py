...
#   - SLV added to TIER_C watchlist (was missing).# active_scanner.py
# ═══════════════════════════════════════════════════════════════════
# Active Watchlist Scanner — Proactive Signal Generation
# NOTE: Educational/demo code. Not financial advice. Use at your own risk.
#
...
class ActiveScanner:
    ...
    def _scan_ticker(self, ticker: str):
        ...
        webhook_data = {
            ...
            # v8.5 (Phase 3.2, Fix A): adx was computed in _analyze_ticker
            # and returned in the signal dict, but dropped from webhook_data.
            # scorer_decisions.csv audit column was blank as a result.
